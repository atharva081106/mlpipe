"""
Configuration models and defaults for MLFlux.
"""
...
from mlflux.core.exceptions import ConfigurationError
...
class PipelineConfig:
    """Configuration settings for an MLFlux run."""
    ...
    random_seed: int = 42
    cv_folds: int = 5
    output_dir: Path = field(default_factory=lambda: Path("./mlflux_runs"))
    verbose: bool = False
