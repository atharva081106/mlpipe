"""
Core Pipeline orchestrator for MLFlux.
...
from mlflux.artifacts.manager import ArtifactManager, load_pipeline_artifact
from mlflux.artifacts.serialization import save_joblib
...
from mlflux.data.profiling import DatasetProfile, profile_dataset
from mlflux.data.splitting import SplitData, split_data
from mlflux.data.validation import ValidationReport, validate_dataset
from mlflux.evaluation.evaluator import build_leaderboard, evaluate_pipeline_on_test
from mlflux.evaluation.metrics import select_primary_metric
from mlflux.explainability.importance import extract_feature_importance
from mlflux.models.selection import get_candidates_for_task
from mlflux.preprocessing.builder import classify_columns, build_preprocessor
...
class Pipeline:
    """
    MLFlux Automated Machine Learning Pipeline.
    ...
    def __init__(
        ...
        random_seed: int = 42,
        cv_folds: int = 5,
        output_dir: Union[str, Path] = "./mlflux_runs",
        verbose: bool = False,
    ...
    def fit(
        ...
        Args:
            data: Filepath to CSV, pandas DataFrame, or MLFlux Dataset.
